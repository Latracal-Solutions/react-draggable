...
export function createCSSTransform(controlPos: ControlPosition, positionOffset: PositionOffsetControlPosition, angle: number): Object {
  const translation = getTranslation(controlPos, positionOffset, 'px', angle);
...
export function getTranslation({x, y}: ControlPosition, positionOffset: PositionOffsetControlPosition, unitSuffix: string, angle: number): string {
  ...
  if (angle) {
    translation = translation + ` rotate(${angle}deg)`;
  }
